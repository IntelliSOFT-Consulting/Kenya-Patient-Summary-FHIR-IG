...
* date = "2026-06-12"
* publisher = "Digital Health Agency of Kenya"
* responsible = "Ministry of Health, Kenya"
* description = "Identifier namespace definition for Kenyan national identification numbers used in the Kenya Patient Summary."
* uniqueId[0].type = #uri
* uniqueId[0].value = "http://moh.kenya/identifier/nationalID-no"
* uniqueId[0].preferred = true
...
* publisher = "Digital Health Agency of Kenya"
* responsible = "Ministry of Health, Kenya"
* description = "Identifier namespace definition for the Kenyan unique patient identifier used in the Kenya Patient Summary."
* uniqueId[0].type = #uri
* uniqueId[0].value = "http://moh.kenya/identifier/UPI"
* uniqueId[0].preferred = true
...
* publisher = "Digital Health Agency of Kenya"
* responsible = "Ministry of Health, Kenya"
* description = "Identifier namespace definition for passport numbers used to identify patients in the Kenya Patient Summary."
* uniqueId[0].type = #uri
* uniqueId[0].value = "http://moh.kenya/identifier/passport-No"
* uniqueId[0].preferred = true
...
* publisher = "Digital Health Agency of Kenya"
* responsible = "Ministry of Health, Kenya"
* description = "Identifier namespace definition for birth certificate numbers used to identify pediatric patients in the Kenya Patient Summary."
* uniqueId[0].type = #uri
* uniqueId[0].value = "http://moh.kenya/identifier/birthCertificate-No"
* uniqueId[0].preferred = true
