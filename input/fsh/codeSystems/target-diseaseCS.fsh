CodeSystem: TargetDiseasesCS
Id: kps-target-diseases-cs
Title: "Target Diseases"
Description: "Custom CodeSystem for target diseases based on ICD-10 disease codes." 
* ^version = "1.0.0"
* ^status = #active
* ^experimental = false
* ^caseSensitive = true
